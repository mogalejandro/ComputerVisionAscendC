...
#ifndef YOLOV3_POST_PROCESS_NEW_H
#define YOLOV3_POST_PROCESS_NEW_H
...
namespace MxBase {
    class Yolov3PostProcessNew: public ObjectPostProcessBase
    {
    public:
        Yolov3PostProcessNew() = default;

        ~Yolov3PostProcessNew() = default;

        Yolov3PostProcessNew(const Yolov3PostProcessNew &other) = default;

        Yolov3PostProcessNew &operator=(const Yolov3PostProcessNew &other);
